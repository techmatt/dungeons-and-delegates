...
Each character has a set of abilities at their disposal. Abilities cannot be traded, and many have restrictions on how often or in what situations they can be used. You can only show the ``use'' side of abilities to another player, and even then only when you chose to use them.

Some characters may have be part of a group that possesses special ``pool abilities''. These are abilities you have access to as a result of your group affiliation. However, all pool abilities have only a finite number of uses, and these are shared across all members of the pool. You may gain access to new pool abilities as a consequence of your membership. Whenever you use a pool ability, you must consult with a GM who may inform you there are no ``charges'' left for that ability -- you will not know how many uses are left until they are expired.
