...
\end{itemize} 
	...
	\NEW{Sign}{\sLock}{
		...
		If you do not have any such item, you may enter this room only if you get a level 4 hand in decking. If anyone asks you what you are doing, you must tell them that you are trying to pick the lock to the room.}
		}
